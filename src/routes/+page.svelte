        ...
        <form class="flex flex-col items-center mt-6 w-full max-w-md mx-auto" on:submit|preventDefault={() => {}}>
          <div class="w-full mb-6">
            ...
            <input 
              ...
              value={studentName} 
              readonly 
              class="border border-gray-300 rounded px-3 py-2 w-full text-sm bg-gray-100"
            />
          ...
          <input 
            type="submit" 
            value="Continue"
            class="bg-yellowish text-white text-sm px-4 py-2 rounded-md hover:bg-yellow-500 w-full shadow-xl"
          />
        </form>
